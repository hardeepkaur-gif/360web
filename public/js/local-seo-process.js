(() => {
  ...
  const LOCAL_SEO_PROCESS_STEPS = [
    {
      ...
      image: "/assets/images/local-seo-process-audit.webp?v=2",
    ...
    },
    {
      ...
      image: "/assets/images/local-seo-process-keywords.webp?v=2",
    ...
    },
    {
      ...
      image: "/assets/images/local-seo-process-onpage.webp?v=2",
    ...
    },
    {
      ...
      image: "/assets/images/local-seo-process-reporting.webp?v=2",
  ...
  // main.js may load after this script and replace activateStep with homepage steps.
  window.addEventListener("load", () => {
    setTimeout(bindLocalSeoProcess, 0);
  });
})();

  ...
  const CRO_PROCESS_STEPS = [
    {
      ...
      image: "/assets/images/cro-process-discovery-audit.webp",
      alt: "Audit notebook with scope, system, priorities, communication, risk and procedure planning diagrams.",
      points: [],
    },
    {
      num: "02",
      ...
      image: "/assets/images/cro-process-hypothesis-design.webp",
      alt: "Designer reviewing website wireframes and landing page mockups during CRO test planning.",
      points: [],
    },
    {
      num: "03",
      ...
      image: "/assets/images/cro-process-tracking-monitoring.webp",
      alt: "Two analysts reviewing conversion tracking dashboards and performance charts on a monitor.",
      points: [],
    },
    {
      num: "04",
      ...
      image: "/assets/images/cro-process-iteration-scaling.webp",
      alt: "Strategist reviewing holographic analytics dashboards to plan iteration and scaling of CRO tests.",
      points: [],
    },
  ];

  ...
  const EMAIL_MARKETING_PROCESS_STEPS = [
    {
      ...
      alt: "Team reviewing email programme audit findings including list health and deliverability metrics.",
      points: [],
    },
    {
      num: "02",
      ...
      alt: "Strategist mapping email segmentation, customer journeys and campaign calendar KPIs.",
      points: [],
    },
    {
      num: "03",
      ...
      image: "/assets/images/ai-marketing-automation.webp",
      alt: "Designer and developer configuring email templates, automation flows and CRM integration.",
      points: [],
    },
    {
      num: "04",
      ...
      alt: "Team monitoring live email campaign launch metrics and deliverability alerts.",
      points: [],
    },
    {
      num: "05",
      ...
      image: "/assets/images/ai-marketing-reporting-insights.webp",
      alt: "Monthly email marketing performance report with optimisation recommendations on screen.",
      points: [],
    },
  ];
